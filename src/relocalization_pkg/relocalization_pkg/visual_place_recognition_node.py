...
class VisualPlaceRecognitionNode(Node):
    def __init__(self):
        super().__init__('visual_place_recognition_node')
        ...
        self.image_dir = '/home/simone/tesi_ws/src/relocalization_pkg/reloc_test/test_1' # Path to save the images 
...
def main(args=None):
    ...
    reloc_capture_node = VisualPlaceRecognitionNode()
